...
# ===========================================================
#
# DESCRICAO: lab04_ex01.py 
#
# Realiza a calibracao de uma camera. Captura 15 imagens que devem
# ser tiradas de uma tabuleiro de xadrez para entao computar a matriz
# da camera e os coeficientes de distorcao. Sao exibidas ao final a
# imagem original e a imagem correspondente corrigida. 
# 
# ===========================================================
...
def FilesNames(preName, ext):
	...
	numFiles = len(os.listdir('.')) - 2 #recebe o numero de arquivos no diretorio 
	val = numFiles
...
for fname in images:
    ...
    # ret, corners = cv.findChessboardCorners(gray, (nCols,nRows), flags=cv.CV_CALIB_FIX_PRINCIPAL_POINT)
