...
def corSelecionada(color):
	if color == 'vermelho' or color == 'red' or color == 'r':
		selectedFrame = bin_red
	elif color == 'azul' or color == 'blue' or color == 'b':
		selectedFrame = bin_blue
	elif color == 'verde' or color == 'green' or color == 'g':
		selectedFrame = bin_green
...
while(True):
    ...
    selectedFrame = corSelecionada(color)
